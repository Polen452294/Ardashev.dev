  ...
  return (
    <>
      ...
      >
        ...
        <TagGridSection
          eyebrow="Возможности"
          title="Что важно в CRM/API-интеграции"
          text="Функции, которые помогают не терять заявки, контролировать передачу данных и поддерживать стабильную работу интеграции."
          items={features}
        />
