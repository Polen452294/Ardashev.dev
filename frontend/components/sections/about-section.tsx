...
const aboutText = (
  <>
    ...
    клиентами, интеграции с API, базами данных и платёжными системами. Работаю с
    CRM, нейросетями, aiogram, Docker, асинхронной архитектурой, базами данных и
    серверным деплоем. Моя задача — превратить идею в стабильное и удобное
